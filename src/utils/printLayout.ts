...
export function getPageDimensions(orientation: 'portrait' | 'landscape', paperSize: string = 'a4') {
  // A4: 210 x 297 mm
...
export function estimateCellSizeMM(rows: number, cols: number, orientation: 'portrait' | 'landscape') {
